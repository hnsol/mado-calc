...
機能や表示を改訂したときは、`docs/decisions/` に 1 件 1 ファイルで理由を記録する。

- ファイル名: `YYYY-MM-DD-テーマ.md`（`docs/decisions/TEMPLATE.md` を使う）
- 背景・検討した案・決定と理由・見送ったことを書く
- このディレクトリは `.gitignore` 済みで GitHub には公開しない。コミット対象に含めないこと
